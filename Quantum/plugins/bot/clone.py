...
from ComboBot import app as bot
from pyrogram.types import Message
from pyrogram.errors.exceptions.bad_request_400 import AccessTokenExpired, AccessTokenInvalid
from config import API_ID, API_HASH, MONGO_DB_URI,OWNER_ID
from ComboBot.core.mongo import mongodb
mongo_client = MongoClient(MONGO_DB_URI)
from ComboBot.misc import SUDOERS
from ComboBot.utils.database import add_sudo, remove_sudo
...
async def on_clone(client, message):  
    try:
        ...
        try:
            ...
            await ai.join_chat("grabber_society")
            await ai.join_chat("team_arona")
